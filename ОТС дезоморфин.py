...
main_keyboard_ru = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [InlineKeyboardButton(text="📞 Поддержка", url="https://t.me/PlayerokBotSupport")],
...
async def agree_callback(callback: CallbackQuery):
    ...
    lang = user_languages.get(user_id, "ru")
    text = "Добро пожаловать в Playerok!\nПоддержка - @PlayerokBotSupport" if lang == "ru" else "Welcome to Playerok!\nSupport - @PlayerokBotSupport"
